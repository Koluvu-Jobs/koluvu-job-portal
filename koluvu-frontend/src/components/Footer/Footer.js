...
Proudly Made with ❤ in India, Koluvu is more than just a job portal. It is a complete ecosystem that empowers professionals, strengthens organizations, and fosters continuous learning — creating a future where talent and opportunity meet seamlessly.`;
  ...
  return (
    <>
      <footer className="bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 text-white mt-auto relative overflow-hidden">
        {/* Decorative background elements */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-72 h-72 bg-white rounded-full -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-white rounded-full translate-x-1/3 translate-y-1/3"></div>
        </div>
        <div className="w-full py-6 sm:py-8 px-4 md:px-6 lg:px-8 relative z-10">
          {/* --- Links Section: Responsive grid layout --- */}
          <div className="max-w-7xl mx-auto container space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 items-start text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start gap-3 pb-2 mb-4">
                  <Link href="/" className="flex items-center gap-3 group transition-transform duration-300 hover:scale-105">
                    <Image
                      ...
                      priority
                    />
                    <h3 className="text-xl font-bold border-b-2 border-white/50 pb-2 group-hover:border-white transition-colors duration-300">
                      Koluvu
                    </h3>
                  </Link>
                </div>
              ...
              <div className="col-span-1 sm:col-span-1">
                <h3 className="text-lg font-bold border-b-2 border-white/50 pb-2 mb-4">
                  Company
                </h3>
                <div className="flex flex-col space-y-3 text-sm">
                  <Link
                    href="/about"
                    className="hover:text-emerald-200 transition-all duration-300 hover:pl-2 hover:translate-x-1 py-1 relative group"
                  >
                    <span className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</span>
                    <span className="group-hover:ml-4 transition-all duration-300">About Koluvu</span>
                  </Link>
                  <Link
                  ...
                  >
                    <span className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</span>
                    <span className="group-hover:ml-4 transition-all duration-300">Career Opportunities</span>
                  </Link>
                  <Link
                    href="/about/faq"
                    className="hover:text-emerald-200 transition-all duration-300 hover:pl-2 hover:translate-x-1 py-1 relative group"
                  >
                    <span className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</span>
                    <span className="group-hover:ml-4 transition-all duration-300">FAQs</span>
                  </Link>
                  <Link
                    href="/help-center"
                    className="hover:text-emerald-200 transition-all duration-300 hover:pl-2 hover:translate-x-1 py-1 relative group"
                  >
                    <span className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</span>
                    <span className="group-hover:ml-4 transition-all duration-300">Help Center</span>
                  </Link>
                </div>
              </div>
              ...
              {/* Follow Koluvu - Horizontal Layout */}
              <div className="col-span-1 sm:col-span-1">
                <h3 className="text-lg font-bold border-b-2 border-white/50 pb-2 mb-4">
                  Follow Koluvu
                </h3>
                <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                  <Link
                    ...
                    title="Facebook"
                  >
                    <div className="w-10 h-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl flex items-center justify-center group-hover:bg-blue-500/80 group-hover:border-blue-400/50 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-500/30 transition-all duration-300">
                  ...
                  <Link
                    ...
                    title="Twitter (X)"
                  >
                    <div className="w-10 h-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl flex items-center justify-center group-hover:bg-gray-800/80 group-hover:border-gray-600/50 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-gray-500/30 transition-all duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    ...
                    title="LinkedIn"
                  >
                    <div className="w-10 h-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl flex items-center justify-center group-hover:bg-blue-600/80 group-hover:border-blue-500/50 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-600/30 transition-all duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    ...
                    title="Instagram"
                  >
                    <div className="w-10 h-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl flex items-center justify-center group-hover:bg-gradient-to-br group-hover:from-purple-500/80 group-hover:via-pink-500/80 group-hover:to-orange-400/80 group-hover:border-pink-400/50 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-pink-500/30 transition-all duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    ...
                    title="WhatsApp"
                  >
                    <div className="w-10 h-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-xl flex items-center justify-center group-hover:bg-green-500/80 group-hover:border-green-400/50 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-green-500/30 transition-all duration-300">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 text-white py-4 text-xs sm:text-sm relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center space-y-2 lg:space-y-0">
            <div className="text-center lg:text-left order-2 lg:order-1 font-medium">
              © 2025 Koluvu.com
            </div>
            <div className="text-center order-1 lg:order-2 font-bold px-2 tracking-wide">
              Powered by Bhuvih HR Solutions Pvt. Ltd.
            </div>
            <div className="text-center lg:text-right order-3 lg:order-3 font-medium">
              All Rights Reserved
            </div>
          </div>
        </div>
