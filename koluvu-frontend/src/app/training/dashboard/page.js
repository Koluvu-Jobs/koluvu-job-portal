// src/app/training/dashboard/page.js
"use client";
  ...
  const [recentActivities, setRecentActivities] = useState([
    {
      id: 1,
      type: "enrollment",
      message: "John Doe enrolled in Web Development Course",
      time: "5 minutes ago",
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      type: "training",
      message: "Advanced Python course published successfully",
      time: "2 hours ago",
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Here's what's happening with your training institute today.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">{stats.totalTrainings}</h3>
              ...
              <div className="p-6">
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-900">Post New Training</span>
                  </Link>
