...
import { trainingGuideContent } from '../trainingGuide';
      ...
      <div className="flex-grow bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h1 className="text-3xl font-bold text-blue-800 mb-8">{trainingGuideContent.title}</h1>
            {trainingGuideContent.sections.map((section, idx) => (
