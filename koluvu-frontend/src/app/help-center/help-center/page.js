    ...
    <div className="bg-white rounded-2xl shadow-lg p-6 h-full">
      <div>
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-3 text-center">Frequently Asked Questions</h1>
          <p className="text-lg text-gray-600 text-center">Find answers to common questions about our platform.</p>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow bg-gray-50">
        <section className="py-12 bg-gradient-to-r from-blue-50 to-blue-100 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-800 mb-4">Welcome to the Koluvu Help Center</h1>
          <p className="text-lg md:text-xl text-blue-700 max-w-2xl mx-auto">We're here to help you succeed. Browse FAQs or contact our support team for personalized assistance.</p>
        </section>
          ...
          <div className="w-full lg:w-1/2 bg-gray-50 p-6">
            <div className="sticky top-20">
              <div className="bg-white rounded-2xl shadow-lg p-8 h-full">
                <h2 className="text-3xl font-bold text-blue-800 mb-8">Quick Navigation</h2>
                <div className="space-y-4">
                  <Link href="/help-center/guides/employer" className="block w-full p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-200 text-left">
                    <h3 className="text-lg font-semibold text-blue-800">🔹 Employer Dashboard Guide</h3>
                    <p className="text-sm text-gray-600">Manage job postings and candidates effectively</p>
                  </Link>
                  <Link href="/help-center/guides/employee" className="block w-full p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-200 text-left">
                    <h3 className="text-lg font-semibold text-blue-800">🔹 Employee Dashboard Guide</h3>
                    <p className="text-sm text-gray-600">Navigate your employee profile and applications</p>
                  </Link>
                  <Link href="/help-center/guides/training" className="block w-full p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-200 text-left">
                    <h3 className="text-lg font-semibold text-blue-800">🔹 Training Dashboard Guide</h3>
                    <p className="text-sm text-gray-600">Access training materials and track progress</p>
                  </Link>
                  <Link href="/help-center/help-center/subscription" className="block w-full p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-200 text-left">
                    <h3 className="text-lg font-semibold text-blue-800">🔹 Subscription Plans</h3>
                    <p className="text-sm text-gray-600">Compare and choose subscription options</p>
                  </Link>
                  <Link href="/features/ai" className="block w-full p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all duration-200 text-left">
                    <h3 className="text-lg font-semibold text-blue-800">🔹 AI Features</h3>
                    <p className="text-sm text-gray-600">Explore AI-powered tools and features</p>
                  </Link>
                </div>
