...
const FuturisticFAQ = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-50 overflow-hidden"
    >
      {/* Animated Background */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:w-1/2 lg:sticky lg:top-24">
            ...
            >
              ...
              <div className="text-center lg:text-left mb-6 sm:mb-8">
                <div className="inline-flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 px-3 sm:px-4 py-1 sm:py-2 bg-orange-50 rounded-full border border-orange-200">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
                  Frequently Asked
                  <br />
                  <span className="text-orange-500 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl">
                    Questions
                  </span>
                </h1>

                <p className="text-slate-600 text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed max-w-lg mx-auto lg:mx-0">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                {[
                  ...
                  <div
                    key={idx}
                    className={`p-3 sm:p-4 bg-white border border-slate-200 rounded-xl hover:border-orange-300 hover:shadow-lg transition-all duration-300 transform hover:scale-105 animate-fade-in-up`}
                    style={{ animationDelay: `${idx * 0.1}s` }}
                  >
                    <div className="text-orange-500 mb-1 sm:mb-2">
                      {feature.icon}
                    </div>
                    <h3 className="text-slate-900 font-semibold text-xs sm:text-sm">
                      {feature.title}
                    </h3>
          ...
          <div className="lg:w-1/2 w-full">
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <div className="relative">
                    {/* Glow Effect */}
                    <div
                      className={`absolute -inset-0.5 bg-gradient-to-r ${faq.color} rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-500`}
                    ></div>

                    <div className="relative bg-white border border-slate-200 rounded-2xl overflow-hidden hover:shadow-lg transition-all">
                      {/* Question Header */}
                      <button
                        onClick={() => toggleFAQ(index)}
                        className="w-full p-4 sm:p-6 text-left flex items-center justify-between hover:bg-slate-50 transition-all duration-300 group"
                      >
                        <div className="flex items-center gap-3 sm:gap-4">
                          ...
                          <span className="text-slate-900 font-semibold text-sm sm:text-base lg:text-lg group-hover:text-orange-600 transition-colors">
                            {faq.question}
                          </span>
                        </div>
                      ...
                      >
                        <div className="p-4 sm:p-6 pt-0">
                          <div className="bg-slate-50 rounded-xl p-3 sm:p-4 border-l-4 border-orange-400">
            ...
            {/* Contact CTA */}
            <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-white border border-orange-200 rounded-2xl text-center shadow-lg">
              <h3 className="text-slate-900 font-semibold text-lg sm:text-xl mb-1 sm:mb-2">
                Still have questions?
              </h3>
              <p className="text-slate-600 text-sm sm:text-base mb-3 sm:mb-4">
                Our support team is here to help you 24/7
              </p>
              <button className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-xl hover:scale-105 transition-transform duration-200 shadow-lg hover:shadow-orange-500/25 text-sm sm:text-base">
                Contact Support
              </button>
            </div>
          </div>
